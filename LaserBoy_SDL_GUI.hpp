...
virtual  void    display_space()
    ...
    //------------------------------------------------------------------------
virtual  void    display_state(string state)
                    {
...
virtual  void    display_progress(int countdown)
    ...
    //------------------------------------------------------------------------
virtual  LaserBoy_color     display_prompt_and_echo_color      (string prompt)
                                {    return LaserBoy_color();        }
    //------------------------------------------------------------------------
virtual  LaserBoy_3D_short  display_prompt_and_echo_3D_short   (string prompt)
                                {    return LaserBoy_3D_short();     }
    //------------------------------------------------------------------------
virtual  LaserBoy_3D_double display_prompt_and_echo_3D_double  (string prompt)
                                {    return LaserBoy_3D_double();    }
    //------------------------------------------------------------------------
virtual  string     display_prompt_file_with_auto_complete     (string prompt, string part = "");
virtual  string     display_prompt_dir_with_auto_complete      (string prompt);
virtual  string     display_prompt_f_effect_with_auto_complete (string prompt);
virtual  string     display_prompt_fs_effect_with_auto_complete(string prompt);
virtual  string     display_prompt_and_echo_name               (string prompt);
virtual  string     display_prompt_and_echo_string             (string prompt);
...
virtual  int        display_prompt_and_echo_nibble             (string prompt);
virtual  bool       display_prompt_and_echo_bool               (string prompt);
virtual  void       display_error                              (string err   );
    //------------------------------------------------------------------------
    // SDL_key menu system
    //------------------------------------------------------------------------
    void    wait_4_key                           ();
    void    check_for_SDL_arrow_keys             (SDLKey key);
    ...
    void    add_color_to_current_palette_menu    ();
    void    add_color_to_target_palette_menu     ();
    void    insert_color_in_current_palette_menu ();
    void    insert_color_in_target_palette_menu  ();
    void    edit_color_in_current_palette_menu   ();
    ...
    //------------------------------------------------------------------------
    void    display_rescale_file_error           (int error);
