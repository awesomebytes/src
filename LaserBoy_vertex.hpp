...
public:
    ...
    LaserBoy_vertex(const LaserBoy_vertex& p)
                 : LaserBoy_3D_short (p.x, p.y, p.z),
                   ...
                   c                 (p.c          )            {}
    //------------------------------------------------------------------------
    LaserBoy_vertex(const LaserBoy_real_vertex& rv) // cast to LaserBoy_vertex
    ...
    //------------------------------------------------------------------------
    bool from_ifstream_txt(ifstream& in, const int& format_1, const int& format_2, int& line_number)
        {
            bool   got_data = false;
            int    next_char;
            double number;
            ...
            {
                if(format_1 == LASERBOY_TABLE)
                {
                    clear();  // this vertex
                    if(format_2 == LASERBOY_RGB)
                    {
                    ...
                    } // end if(format_2 == LASERBOY_RGB)
                    else if(format_2 == LASERBOY_HEX)
                    {
                    ...
                    } // end else if(format_2 == LASERBOY_HEX)
                } // end if(format_1 == LASERBOY_TABLE)
                //.......................................
                else // It is not a table. It's a frame!
                {
                    if(get_next_number(in, number, line_number)) // 1
                    {
                        ...
                        if(get_next_number(in, number, line_number)) // 2
                        {
                            ...
                            //.................
                            // if there is a z
                            if(    format_1 == LASERBOY_3D_FRAME_RGB
                                || format_1 == LASERBOY_3D_FRAME_HEX
                                || format_1 == LASERBOY_3D_FRAME_PALETTE
                                || format_1 == LASERBOY_3D_FRAME_TABLE
                              )
                            {
                                if(get_next_number(in, number, line_number))
                                {
                            ...
                            if(    (    (format_1 == LASERBOY_3D_FRAME_RGB)
                                     || (format_1 == LASERBOY_2D_FRAME_RGB)
                                   )
                            ...
                            //.................
                            // if there is a hex
                            else if(    (    (format_1 == LASERBOY_3D_FRAME_HEX)
                                          || (format_1 == LASERBOY_2D_FRAME_HEX)
                                        )
                            ...
                            else if(    (    (format_1 == LASERBOY_3D_FRAME_PALETTE)
                ...
                } // end else of if(format_1 == LASERBOY_TABLE)
            }
    ...
    //------------------------------------------------------------------------
    LaserBoy_3D_short position() const {  return (LaserBoy_3D_short)(*this); }
    //------------------------------------------------------------------------
    int color() const
        {
            return   is_lit()
    ...
    //------------------------------------------------------------------------
    LaserBoy_vertex bit_masked(const int signal_bit_mask[8]) const
                    {
    ...
    //------------------------------------------------------------------------
    LaserBoy_3D_short bit_masked_position(const int signal_bit_mask[8]) const
                        {
    ...
    //------------------------------------------------------------------------
    LaserBoy_color bit_masked_color(const int signal_bit_mask[8]) const
                    {
...
//############################################################################
typedef vector<LaserBoy_vertex>      LaserBoy_segment_base;
