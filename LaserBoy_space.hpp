...
{
public:
    LaserBoy_space(LaserBoy_GUI_base* gui);
    //------------------------------------------------------------------------
virtual
   ~LaserBoy_space()
    {
    ...
    //------------------------------------------------------------------------
    LaserBoy_space& operator  = (const LaserBoy_space& space)
                    {
                        LaserBoy_palette_set::clear();
                        LaserBoy_palette_set::reserve(space.number_of_palettes());

                        LaserBoy_palette_set::insert (LaserBoy_palette_set::end(),
                                                      space.LaserBoy_palette_set::begin(),
                                                      space.LaserBoy_palette_set::end()
                                                     );
                        //....................................................
                        LaserBoy_frame_set::clear();
                        LaserBoy_frame_set::reserve(space.number_of_frames());
                        LaserBoy_frame_set::insert (LaserBoy_frame_set::end(),
                                                    space.LaserBoy_frame_set::begin(),
                                                    space.LaserBoy_frame_set::end()
                                                   );
                        return *this;
                    }
    //------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------
    LaserBoy_space& operator += (const LaserBoy_palette_set& palettes)
                    {
                        LaserBoy_palette_set::insert(LaserBoy_palette_set::end(),
                                                     palettes.begin(),
                                                     palettes.end()
    ...
    void clean_screen                 ();
    //------------------------------------------------------------------------
    void rename_all_frames            (string name);
    //------------------------------------------------------------------------
    ...
    int  load_color_rescale_file      (int color_channel);
    int  color_rescales_flags         ();
    //------------------------------------------------------------------------
    void load_frame_effects           ();
    void load_frame_set_effects       ();
    int  call_frame_effect            (string name);
    int  call_frame_set_effect        (string name);
    //------------------------------------------------------------------------
    void load_background_bitmap       (struct LaserBoy_bmp* bmp);
    bool load_background_bitmap       (string file             );
    ...
    //------------------------------------------------------------------------
    bool apply_wave_offsets_prep       (string file);
    bool overwirte_wave_offsets        (string file);
    bool invert_wave_prep              (string file);
    bool invert_signals_prep           (string file);
    bool clear_wave_polarity_list      (string file, bool global_flip_flop);
    bool apply_color_rescales_prep     (string file);
    bool omit_color_rescales           (string file);
    bool save_color_rescales           (string file,    string out_name   );
    bool black_level_to_wave_prep      (string file_in, string file_out   );
    bool bit_resolution_to_wave_prep   (string file_in, string file_out   );
    //------------------------------------------------------------------------
    ...
    //------------------------------------------------------------------------
    bool join_XY_r_g_b_i_waves_prep    (string file_XY,
                                        string file_r,
                                        string file_g,
                                        string file_b,
                                        string file_i,
    ...
    //------------------------------------------------------------------------
    bool join_XY_rg_b_waves_prep       (string file_XY,
                                        string file_rg,
                                        string file_b,
                                        string file_out,
                                        bool   global_polarity
    ...
    //------------------------------------------------------------------------
    bool join_XY_rg_b_LR_waves_prep    (string file_XY,
                                        string file_rg,
                                        string file_b,
                                        string file_LR,
                                        string file_out,
    ...
    //------------------------------------------------------------------------
    bool add_audio_to_wave_prep        (string file_laser,
                                        string file_audio,
                                        string file_out
                                       );
    //------------------------------------------------------------------------
    ...
    string LaserBoy_wave_LSB_tag_to_name    (const short& LSB_tag  ) const;
